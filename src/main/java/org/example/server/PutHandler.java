...
public class PutHandler {
  ...
  public static void handlePut(
      ...
      DataBaseWrapper db,
      int clientID,
      String[] parsedHTTP) { // TODO: make the method static
  ...
  public static void putNotificationFromClient(
      Socket socket, DataBaseWrapper db, String jsonBody, int clientID) {
    ...
    try (OutputStream out = socket.getOutputStream()) {
      ...
      payload =
          new JSONObject().put("status", "ok").put("clientId", clientID).put("webIds", webIds);
